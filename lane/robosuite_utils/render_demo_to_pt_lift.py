...
def main():
    ...
    parser.add_argument("--num_demos", type=int, default=10, help="Number of demos to render")
    args = parser.parse_args()

    hdf5_path = f"{PROJECT_ROOT}/lane/demo/robomimic_dataset/lift/demo_v15.hdf5"
    ...
    target_folder = f"{PROJECT_ROOT}/lane/demo/robomimic_lift/{num_demos}"
