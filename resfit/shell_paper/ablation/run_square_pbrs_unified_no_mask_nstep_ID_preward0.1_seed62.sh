...
# Script to run Residual TD3 with Potential-Based Reward Shaping WITHOUT Terminal Masking (Unified Latent Space Ablation, Seed 62)
...
while [[ "$#" -gt 0 ]]; do
    case $1 in
        ...
        --offline_buffer_path) OFFLINE_BUFFER_PATH="$2"; shift ;;
...
echo "=================================================="
echo "Starting Residual TD3 Training for Square with Unified V-PBRS (No Terminal Masking, Seed 62)"
...
export CACHE_DIR=${PROJECT_ROOT}/scratch/square_unified_seed62_${CURRENT_TIME}
