...
# Script to run Residual TD3 with Potential-Based Reward Shaping WITHOUT Terminal Masking (Unified Latent Space Ablation, 1000k Steps)
...
echo "=================================================="
echo "Starting Residual TD3 Training for Square with Unified V-PBRS (No Terminal Masking, 1000k Steps)"
