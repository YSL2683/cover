...
# Script to run Residual TD3 with Potential-Based Reward Shaping WITHOUT Terminal Masking (Unified Latent Space Ablation, Seed 52)
...
echo "=================================================="
echo "Starting Residual TD3 Training for Square with Unified V-PBRS (No Terminal Masking, Seed 52)"
...
export CACHE_DIR=${PROJECT_ROOT}/scratch/square_unified_seed52_${CURRENT_TIME}
