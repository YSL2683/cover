...
# Script to run Residual TD3 with Potential-Based Reward Shaping WITHOUT Terminal Masking for Can
...
BASE_POLICY_PATH="${PROJECT_ROOT}/resfit/my_lerobot_data/bc_run_2026-09-06_17-03-49_robomimic_can_v15_30_diffusion/best/policy"
E2C_DIR="${PROJECT_ROOT}/lane/pretrained_e2c/can"
OFFLINE_DATA_DIR="${PROJECT_ROOT}/resfit/my_lerobot_data/ysl2683/robomimic_can_v15_30"
...
echo "=================================================="
echo "Starting Residual TD3 Training for Can with V-PBRS (No Terminal Masking)"
