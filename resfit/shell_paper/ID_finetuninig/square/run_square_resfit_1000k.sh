...
# Script to run Residual TD3 (ResFiT Baseline) WITHOUT Additional Reward Shaping (Reward None) for Square (1000k Steps)
...
WANDB_NAME="${TASK}_ID_resfit_1000k_seed${SEED}"
...
echo "=================================================="
echo "Starting Residual TD3 (ResFiT) Training for Square WITHOUT Additional Reward (1000k Steps)"
