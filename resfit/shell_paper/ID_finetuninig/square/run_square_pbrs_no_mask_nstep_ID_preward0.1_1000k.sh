...
# Script to run Residual TD3 with Potential-Based Reward Shaping WITHOUT Terminal Masking (1000k Steps)
...
while [[ "$#" -gt 0 ]]; do
    case $1 in
        ...
        --seed) SEED="$2"; WANDB_NAME="${TASK}_${REWARD_TYPE}_beta${BETA}_scale${P_REWARD}_1000k_seed${SEED}"; shift ;;
...
echo "=================================================="
echo "Starting Residual TD3 Training for Square with V-PBRS (1000k Steps)"
