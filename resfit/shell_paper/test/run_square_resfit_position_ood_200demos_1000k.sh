...
# Script to run Residual TD3 (Vanilla ResFiT Baseline) on Square Position OOD without Additional Reward Shaping (1000k Steps, 200 Demos)
...
WANDB_NAME="${TASK}_position_ood_4.875x15.875_resfit_200demos_1000k_seed${SEED}"
CUSTOM_WANDB_NAME=""
...
echo "=================================================="
echo "Starting Residual TD3 (ResFiT) Training for Square Position OOD (No Additional Reward, 200 Demos, 1000k Steps)"
...
export CACHE_DIR=${PROJECT_ROOT}/scratch/square_pos_ood_resfit_200demos_${CURRENT_TIME}
