...
# Script to run Residual TD3 with Potential-Based Reward Shaping using Decoupled Latents & Similarity-Weighted Remaining Timesteps (1000k Steps, 200 Demos)
# Task        : Square Position OOD (Span: 4.875 cm x 15.875 cm)
# Base Policy : 200 Demos Diffusion Policy
# E2C Encoder : lane/pretrained_e2c/square_200 (Decoupled: Main & Wrist)
...
# E2C directory (Decoupled 200 demos) and Offline data directory for 200 demos
...
WANDB_NAME="${TASK}_position_ood_4.875x15.875_${REWARD_TYPE}_beta${BETA}_scale${P_REWARD}_200demos_1000k_seed${SEED}"
CUSTOM_WANDB_NAME=""
...
echo "=================================================="
echo "Starting Residual TD3 Training for Square Position OOD with Decoupled Similarity-Weighted PBRS (200 Demos, 1000k Steps)"
echo "Target Task      : $TASK (Position OOD: X[-0.136875, -0.088125], Y[0.088125, 0.246875])"
echo "Total Timesteps  : $TOTAL_TIMESTEPS"
echo "Reward Type      : $REWARD_TYPE"
echo "E2C Mode         : decoupled"
...
export CACHE_DIR=${PROJECT_ROOT}/scratch/square_pos_ood_weighted_time_200demos_${CURRENT_TIME}
