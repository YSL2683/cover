...
# Script to run Residual TD3 with Potential-Based Reward Shaping using Similarity-Weighted Remaining Timesteps (Alternative B, 1000k Steps)
...
WANDB_NAME="${TASK}_${REWARD_TYPE}_beta${BETA}_scale${P_REWARD}_1000k_seed${SEED}"
CUSTOM_WANDB_NAME=""
...
echo "=================================================="
echo "Starting Residual TD3 Training for Square with Similarity-Weighted Timestep PBRS (1000k Steps)"
...
export CACHE_DIR=${PROJECT_ROOT}/scratch/square_weighted_time_${CURRENT_TIME}
