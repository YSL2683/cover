...
# Script to run Residual TD3 with Potential-Based Reward Shaping using Unified E2C Latent Space (1000k Steps, 200 Demos)
# Task        : Square Position OOD (Span: 4.875 cm x 15.875 cm)
# Base Policy : 200 Demos Diffusion Policy
# E2C Encoder : lane/pretrained_e2c_unified/square_200 (Unified: Concatenated Front + Wrist)
...
echo "=================================================="
echo "Starting Residual TD3 Training for Square Position OOD with Unified E2C PBRS (200 Demos, 1000k Steps)"
...
export CACHE_DIR=${PROJECT_ROOT}/scratch/square_pos_ood_unified_200demos_${CURRENT_TIME}
