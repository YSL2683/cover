...
# Script to run Residual TD3 (ResFiT Baseline) WITHOUT Additional Reward Shaping (Reward None) for Square (1000k Steps, 200 Demos)
...
WANDB_NAME="${TASK}_ID_resfit_200demos_1000k_seed${SEED}"
...
echo "=================================================="
echo "Starting Residual TD3 (ResFiT) Training for Square (No Additional Reward, 200 Demos, 1000k Steps)"
...
export CACHE_DIR=${PROJECT_ROOT}/scratch/square_resfit_200demos_${CURRENT_TIME}
