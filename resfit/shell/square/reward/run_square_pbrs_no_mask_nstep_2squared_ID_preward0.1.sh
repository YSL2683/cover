...
# Default parameters
REWARD_TYPE="reward_pbrs_no_mask_nstep_2squared"
BETA=1.0
ALPHA=0.98
W_M=0.3
W_W=0.7
...
WANDB_NAME="${TASK}_${REWARD_TYPE}_beta${BETA}_scale${P_REWARD}_ddim20"
...
echo "=================================================="
echo "Starting Residual TD3 Training for Square with V-PBRS (No Terminal Masking, 2-Squared Kernel)"
