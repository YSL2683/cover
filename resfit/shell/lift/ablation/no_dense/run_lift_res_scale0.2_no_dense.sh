...
WANDB_NAME="res_scale${ACTION_SCALE}_sparse_only"
...
echo "=================================================="
echo "Starting Residual TD3 Training (NO DENSE REWARD, Increased Scale)"
echo "Reward Type     : $REWARD_TYPE"
echo "Action Scale    : $ACTION_SCALE"
echo "Seed            : $SEED"
echo "Base Policy Path: $BASE_POLICY_PATH"
echo "WandB Name      : $WANDB_NAME"
echo "Environment     : [-0.1, 0.1] bounds, No disturbance"
echo "=================================================="
