...
# Script to run Residual TD3 with Soft-Synchronized PBRS (Softmax-Similarity Sync)

# Default parameters
REWARD_TYPE="reward_pbrs_softsync"
BETA=1.0
ALPHA=0.98
W_M=0.3
W_W=0.7
...
WANDB_NAME="pbrs_softsync_beta${BETA}_scale${P_REWARD}_freeze"
...
echo "=================================================="
echo "Starting Residual TD3 Training with Time-SoftSynced V-PBRS"
