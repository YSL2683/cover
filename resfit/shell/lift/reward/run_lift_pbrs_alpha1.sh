#!/bin/bash
# Script to run Residual TD3 with Original PBRS but alpha=1.0 (No timeline matching constraint)

# Default parameters
REWARD_TYPE="reward_pbrs"
BETA=1.0
ALPHA=1.0  # Set to 1.0 to eliminate the effect of the time-discount parameter
W_M=0.3
W_W=0.7
P_REWARD=100.0  
SEED=42
...
WANDB_NAME="pbrs_alpha1.0_beta${BETA}_scale${P_REWARD}_freeze"
...
echo "=================================================="
echo "Starting Residual TD3 Training with Original PBRS (Alpha=1.0)"
