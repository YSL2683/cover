...
echo "Environment     : Viewpoint Rolled 20 deg (quat=[0.4549, 0.4989, 0.3493, 0.6497]), 5x5cm spawn area"
echo "=================================================="
...
python resfit/rl_finetuning/scripts/train_residual_td3.py \
    env_modifier.mode=camera_ood \
    env_modifier.camera_ood.camera_name="frontview" \
    env_modifier.camera_ood.set_quat="[0.4549, 0.4989, 0.3493, 0.6497]" \
