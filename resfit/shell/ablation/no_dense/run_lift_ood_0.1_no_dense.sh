#!/bin/bash
# Script to run Residual TD3 WITHOUT dense reward (ablation study) with OOD range 0.1
...
WANDB_NAME="residual_td3_sparse_only_ood_0.1"
...
echo "=================================================="
echo "Starting Residual TD3 Training (NO DENSE REWARD, OOD 0.1)"
